        ...
        <table class="table table-bordered table-responsive table-hover">
            ...
            <c:forEach var="ins" items="${listInstalment}">
                ...
                <c:choose>
                    ...
                    <td>
                        <div class="row">
                            <a href="<c:url value='/transactions/info/${ins.ins_transaction.tra_id}'/>" class="col-xs-offset-1 col-xs-3"> <span class="glyphicon glyphicon-eye-open" ></span></a>
                            <a href="" class="col-xs-4"> <span class="glyphicon glyphicon-pencil"></span></a>
                            <button class="col-xs-3"><span class="glyphicon glyphicon-trash"></span></button>
                        </div>
                    </td>
                </tr>
            </c:forEach>
